...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <form action="product_update.php" method="post" name="form">
            <input type="hidden" name="token" value="<?= $token ?>">
            <input type="hidden" name="update" value="<?= $update ?>">
            <div class="form-group">
                <label for="product">PCモデル名:</label>
                <input type="text" id="product" class="form-control" name="product" placeholder="<?= $_POST["item_name"] ?>">
            </div>
